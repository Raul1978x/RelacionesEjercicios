package ejerciciorelacionesextran02;

/**
 * 2. Nos piden hacer un programa sobre un Cine, que tiene una sala con un
 * conjunto de asientos (8 filas por 6 columnas). De Cine nos interesa conocer
 * la película que se está reproduciendo, la sala con los espectadores y el
 * precio de la entrada. Luego, de las películas nos interesa saber el título,
 ...
 * espacio vacío. Se debe realizar una pequeña simulación, en la que se generen
 * muchos espectadores y se los ubique en los asientos aleatoriamente (no se
 * puede ubicar un espectador donde ya este ocupado el asiento). Los
 ...
 */
public class ejerciciorelacionesextran02 {
